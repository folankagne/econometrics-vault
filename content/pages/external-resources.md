...
---
A [non-exhaustive] collection of resources for learning causal inference, econometrics, and data analysis. Mirrored from the `/econometrics-resources/` page on my personal site (last updated there: February 2026) — kept here too so it's searchable and cross-linkable alongside the rest of the vault.
...
* ['Metrics Notes (Peter Hull)](https://about.peterhull.net/metrix) — Collection of lecture slides (undergraduate and graduate applied econometrics) [OG].
...
* [Graduate Econometrics Course (Ben Lambert)](https://youtu.be/GMVh02WGhoc?si=K744zbL1Ojloh1XR) [Carré dans l'axe ++]
...
* [Doubly Robust Estimation of Treatment Effects with Machine Learning Methods](https://www.youtube.com/watch?v=IfZHUFFlsGc&t=382s)
...
* [A Crash Course in Good and Bad Controls (Judea Pearl)](https://ftp.cs.ucla.edu/pub/stat_ser/r493.pdf)
...
* [Essence of Linear Algebra (3Blue1Brown)](https://youtu.be/fNk_zzaMoSs?si=TQWUk_HNgawuYmyy)
...
* [Econometrics With Python (Weijie Chen, 2022)](https://github.com/weijie-chen/Econometrics-With-Python)
...
*Mirrored from the `/econometrics-resources/` page on my personal site, last updated there: February 2026.*
